  ...
  win = {
    ...
    input = {
      keys = {
        ...
        ["<CR>"] = { "confirm", mode = { "n", "i" }, weight = 100 },
        ["<Down>"] = { "list_down", mode = { "i", "n" } },
        ["<Esc>"] = { "cancel", weight = 90 },
        ["<S-CR>"] = { { "pick_win", "jump" }, mode = { "n", "i" } },
        ["<S-Tab>"] = { "select_and_prev", mode = { "i", "n" }, weight = 70 },
        ["<Tab>"] = { "select_and_next", mode = { "i", "n" }, weight = 70 },
        ["<Up>"] = { "list_up", mode = { "i", "n" } },
        ...
        ["<c-q>"] = { "qflist", mode = { "i", "n" } },
        ["<c-s>"] = { "edit_split", mode = { "i", "n" }, weight = 80 },
        ["<c-t>"] = { "tab", mode = { "n", "i" }, weight = 80 },
    ...
    list = {
      keys = {
        ["/"] = "toggle_focus",
        ["<2-LeftMouse>"] = { "confirm", weight = 100 },
        ["<CR>"] = { "confirm", weight = 100 },
        ["<Down>"] = "list_down",
        ["<Esc>"] = { "cancel", weight = 90 },
        ["<S-CR>"] = { { "pick_win", "jump" } },
        ["<S-Tab>"] = { "select_and_prev", mode = { "n", "x" }, weight = 70 },
        ["<Tab>"] = { "select_and_next", mode = { "n", "x" }, weight = 70 },
        ["<Up>"] = "list_up",
        ["<a-d>"] = "inspect",
        ["<a-f>"] = "toggle_follow",
        ["<a-h>"] = "toggle_hidden",
        ...
        ["<c-q>"] = "qflist",
        ["<c-g>"] = "print_path",
        ["<c-s>"] = { "edit_split", weight = 80 },
        ["<c-t>"] = { "tab", weight = 80 },
        ["<c-u>"] = "list_scroll_up",
        ["<c-v>"] = { "edit_vsplit", weight = 80 },
        ["<c-w>H"] = "layout_left",
        ["<c-w>J"] = "layout_bottom",
        ["<c-w>K"] = "layout_top",
        ["<c-w>L"] = "layout_right",
        ["?"] = { "toggle_help_list", weight = 10 },
        ["G"] = "list_bottom",
        ["gg"] = "list_top",
        ["i"] = "focus_input",
        ["j"] = "list_down",
